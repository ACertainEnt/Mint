...
import { ShieldCheck, Settings, Users, AlertCircle, CheckCircle2, Lock, DollarSign, Bot, Cpu, Layers, Check, X, Clock, ExternalLink, HelpCircle, Award, Sparkles, RefreshCw, ChevronDown, ChevronUp } from 'lucide-react';
                ...
                <div key={u.id} className="py-3 flex items-center justify-between gap-2">
                  <div className="flex items-center gap-2.5 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="text-[10px] font-mono-code text-[#6b7280] truncate flex items-center gap-1">
